...
const Store_1 = __webpack_require__(69);
...
function useSave(options, callback = () => { }) {
    const [_a, dispatch] = (0, __1.useGlobalState)(), state = __rest(_a, []);
...
async function useRequest(options, method, callback) {
    const [, dispatch] = (0, __1.useGlobalState)();
    if (typeof options === 'undefined') {
 ...
 */
function useGet(options, callback = (res, err = null) => { }) {
    const [_a, dispatch] = (0, State_1.useGlobalState)(), state = __rest(_a, []);
    ...
    if (typeof options === 'undefined' || options === null) {
        return (options, callback = (response, error) => { }) => {
...
const hooks_1 = __webpack_require__(56);
 ...
 * The generic must be the `typeof` the entities config object
 */
const useGlobalState = () => React.useContext(exports.StateContext);
...
const useProcessQueue_1 = __webpack_require__(57);
...
const utils_1 = __webpack_require__(3);
const __1 = __webpack_require__(0);
const __2 = __webpack_require__(5);
const entities_1 = __webpack_require__(58);
const getIsOnline = () => {
...
function useProcessQueue() {
    const [state] = (0, __1.useGlobalState)();
    const rlean_offlineQueue = (0, utils_1.getValue)(state, 'rlean_offlineQueue', undefined);
    const [isOnline, setIsOnline] = (0, react_1.useState)(getIsOnline());
    const post = (0, __1.usePost)();
    const del = (0, __1.useDelete)();
    const put = (0, __1.usePut)();
    const patch = (0, __1.usePatch)();
    const remove = (0, __1.useRemove)();
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (isOnline) {
            const data = (0, utils_1.getValue)(rlean_offlineQueue, 'data', []);
...
const RLean_OfflineQueue_1 = __webpack_require__(59);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const define_1 = __webpack_require__(49);
const RLean_OfflineQueue = (0, define_1.define)("rlean_offlineQueue", {});
...
function useSyncState() {
    ...
    const syncState = (0, react_1.useCallback)(() => {
        const entityDefinitions = (0, utils_1.getValue)(__1.RLean, 'config.entities', {});
        const objects = Object.values(entityDefinitions);
...
const utils_1 = __webpack_require__(3);
const _1 = __webpack_require__(0);
const middleware_1 = __webpack_require__(67);
