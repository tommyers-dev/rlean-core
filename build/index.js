...
function () {
  ...
  regeneratorRuntime.mark(function _callee(payload, nullableParams, method) {
    var headers, apiWrapper, uri, path, query, key;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 17:
            _context.t2 = method;
            _context.next = _context.t2 === 'get' ? 20 : _context.t2 === 'post' ? 27 : _context.t2 === 'put' ? 30 : _context.t2 === 'delete' ? 31 : 32;
            break;
          ...
          case 20:
            ...
            _context.next = 23;
            return apiWrapper(axios__WEBPACK_IMPORTED_MODULE_0___default.a, uri + path, {
              headers: headers
            });
