...
var getModelOptions = function getModelOptions(key, options) {
  var _options$getURL, _options$postURL, _options$putURL, _options$patchURL, _options$deleteURL, _options$nullablePara, _options$persistData, _options$preferStore, _options$progressiveL, _options$syncInterval, _options$syncAfterTim, _options$adapters, _options$type, _options$updateState, _options$reducer;
...
var formatPath = function formatPath(path, payloadQuery, payloadBody, method, nullableParams, opts) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            _getHookOptions = Object(_internal__WEBPACK_IMPORTED_MODULE_3__["getHookOptions"])(options), model = _getHookOptions.model, value = _getHookOptions.value, type = _getHookOptions.type;

            if (model.persistData) {
              ___WEBPACK_IMPORTED_MODULE_2__["Store"].set(model, value);
            }

            ___WEBPACK_IMPORTED_MODULE_2__["RLean"].model = model;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              response = Object(_internal__WEBPACK_IMPORTED_MODULE_1__["request"])(payload, model, _internal__WEBPACK_IMPORTED_MODULE_1__["methods"].POST);
